...
class ModelFeatureLoader:
    ...
    def load_stock_model_training_dataset_from_feast_online(
        ...
        if entity_df.empty or close_dataset.is_empty():
            return ModelFeatureLoader._empty_model_training_dataset_frame(feature_columns)
        ...
        frames = []
        for batch_df, entity_rows in ModelFeatureLoader._tier2_online_entity_batches(entity_df):
    ...
    def load_stock_tier1_model_dataset_from_feast_online() -> pl.DataFrame:
        return ModelFeatureLoader.load_stock_model_training_dataset_from_feast_online(
