...
class PecnetMlflowTracker:
    ...
    def _pecnet_epoch_metrics_frame(
        *,
        ...
        rows = []
        for network_name, model in PecnetMlflowTracker._iter_pecnet_basic_models(pecnet):
    ...
    def _log_pecnet_epoch_metrics_to_mlflow(
        *,
        ...
        epoch_metrics = PecnetMlflowTracker._pecnet_epoch_metrics_frame(
            pecnet=pecnet,
            ticker=ticker,
            tier_name=tier_name,
        )
