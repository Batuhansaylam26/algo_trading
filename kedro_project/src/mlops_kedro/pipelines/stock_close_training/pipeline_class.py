...
class StockClosePipelineFactory:
        ...
        return [
            *model_matrix_nodes(wait_for_feature_publish=wait_for_feature_publish),
            node(
                ...
                inputs=StockClosePipelineFactory._root_model_performance_inputs(),
                outputs=[
    ...
    def create_feature_engineering_pipeline(**kwargs) -> Pipeline:
        return Pipeline(
            [
                *StockClosePipelineFactory._feature_engineering_context_nodes(load_silver=True),
                *StockClosePipelineFactory._close_model_dataset_nodes(),
                *StockClosePipelineFactory._indicator_feature_nodes(),
            ]
        )
    ...
    def create_conventional_gap_trading_pipeline(**kwargs) -> Pipeline:
        return Pipeline(
            [
                *StockClosePipelineFactory._feature_engineering_context_nodes(load_silver=False),
                *StockClosePipelineFactory._load_indicator_feature_nodes(),
                *StockClosePipelineFactory._conventional_gap_trading_nodes(),
            ]
        )
    ...
    def create_machine_learning_pipeline(**kwargs) -> Pipeline:
        return Pipeline(
            [
                *StockClosePipelineFactory._machine_learning_nodes("machine_learning_summary"),
            ]
        )

    @staticmethod
    def create_mlflow_root_performance_pipeline(**kwargs) -> Pipeline:
        return Pipeline(
            [
                node(
                    func=stock_close_model_nodes.evaluate_root_model_performance_from_mlflow,
                    inputs="params:stock_close_machine_learning.mlflow",
                    outputs=[
                        "root_model_performance_predictions",
                        "root_model_performance_regression_metrics",
                        "root_model_performance_long_direction_metrics",
                    ...
                    name="evaluate_root_model_performance_from_mlflow",
                ),
            ]
        )
    ...
    def create_pipeline(**kwargs) -> Pipeline:
        return Pipeline(
            [
                ...
                *StockClosePipelineFactory._indicator_feature_nodes(),
                *StockClosePipelineFactory._conventional_gap_trading_nodes(),
                *StockClosePipelineFactory._machine_learning_nodes(
